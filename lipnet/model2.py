...
from tensorflow.keras.layers import Conv3D, ZeroPadding3D,MaxPooling3D,Dense, Activation,SpatialDropout3D,Flatten,Bidirectional,TimeDistributed,GRU,BatchNormalization
...
class LipNet(object):
    ...
    def build(self):
        ...
        self.drop1 = SpatialDropout3D(0.5,name='spatial1')(self.actv1)
        ...
        self.drop2 = SpatialDropout3D(0.5,name='spatial2')(self.actv2)
        ...
        self.drop3 = SpatialDropout3D(0.5,name='spatial3')(self.actv3)
        self.maxp3 = MaxPooling3D(pool_size=(1, 2, 2), strides=(1, 2, 2), name='max3')(self.drop3)

        self.resh1 = TimeDistributed(Flatten())(self.maxp3)

        self.gru_1 = Bidirectional(GRU(256, return_sequences=True, kernel_initializer='Orthogonal', name='gru1',reset_after=False), merge_mode='concat',name='bidirection1')(self.resh1)
        self.gru_2 = Bidirectional(GRU(256, return_sequences=True, kernel_initializer='Orthogonal', name='gru2',reset_after=False), merge_mode='concat',name='bidirection2')(self.gru_1)
        ...
        self.baseModel = Model(inputs=self.input_data, outputs=self.y_pred)

    def summary(self):
        self.baseModel.summary()

    def predict(self, input_batch):
        return self.baseModel([input_batch, 0]).numpy()  
